...
class Model_Db_Transferencia extends Model_Db
{
	...
	protected $_name = 'transferencia';
	protected $_select = false;
	protected $_dependentTables = array(
		'Model_Db_Estoqueembriao',
		'Model_Db_Fichario',
		'Model_Db_Tecnico',
	);
	/*
...
//			->joinLeft(array('tipo' => 'cobertura_tipo'), 'c.cobertura_tipo_id = tipo.id', array(), $this->_schema)
	...
	public function listJsonTransferencia($cols = '*', $orderby = false, $order = false, $page = false, $limit = false, $qtype = false, $query = false, $like = false, $params = array())
	{
		...
		$this->_select = $this->select()
			...
			->joinLeft(array('v' => 'fichario'), 't.fichario_id = v.id', array(), $this->_schema)
			->joinLeft(array('tec' => 'tecnico'), 't.tecnico_id = tec.id', array(), $this->_schema)
			->joinLeft(array('e' => 'estoqueembriao'), 't.embriao_id = e.id', array(), $this->_schema)
			->order($orderby .' '. $order)
			;
