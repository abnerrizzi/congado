...
$portugues['emailAddressInvalidFormat'] = "'%value%' Nгo й um endereзo de email vбlido no formato bбsico usuario@servidor";
...
$portugues['dateInvalidDate'] = "'%value%' nгo parece ser uma data vбlida";
 ...
 * IsImage
 */
$portugues['fileIsImageFalseType'] = "O arquivo '%value%' nгo й uma imagem, '%type%' detectado";
$portugues['fileIsImageNotDetected'] = "O mimetype do arquivo '%value%' nгo foi detectado";
$portugues['fileIsImageNotReadable'] = "O arquivo '%value%' nгo pode ser lido";

/*
 * Size
 */
$portugues['fileSizeTooBig'] = "Tamanho mбximo permitido para o arquivo '%value%' й '%max%' mas '%size%' foi detectado";
$portugues['fileSizeTooSmall'] = "Tamanho mнnimo esperado para o  arquivo '%value%' й '%min%' mas '%size%' foi detectado";
$portugues['fileSizeNotFound'] = "Arquivo '%value%' nгo pфde ser encontrado";
