...
//		__baseUrl = baseUrl + '/' + __module;
	...
	$("#add>a").before(
			...
			'<span class="UIButton_Search UIButton_IconNoSpriteMap_Search UIButton_IconSmallMonochromatic" style="background: url(/images/search.png) no-repeat;background-position: 4pt 1px;"></span>\n'+
			'Pesquisar\n'+
			'</span></a>\n'+
			'\n'
	);
