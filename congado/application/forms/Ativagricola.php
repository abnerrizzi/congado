 ...
 *
 * @version: $Id: Ativagricola.php 9 2010-01-08 12:59:43Z bacteria_ $
 * 
 */

class Form_Ativagricola extends Zend_Dojo_Form
{
	...
	{
		parent::__construct();
		$this->setName('atividades_agricolas');
		...
		$this->addElement('text', 'cod', array(
			...
			'validators' => array(new Zend_Validate_Db_NoRecordExists('ativagricola','cod')),
			'maxlength' => 2,
			'size' => 2,
			'class'	=> 'input',
		));
