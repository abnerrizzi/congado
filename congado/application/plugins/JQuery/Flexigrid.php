 ...
 * @filesource
 * 
 * @version: $Id: Flexigrid.php 52 2010-01-25 19:53:43Z bacteria_ $
 * 
 */
class Plugin_JQuery_Flexigrid
{
	...
	{
		if ( $type instanceof Plugin_JQuery_Flexigrid_Column_Abstract )
		{
			$column = $type;
			unset($type);
		}
	...
	public function setSelector($selector)
	{
		if ( empty($selector) )
		{
			throw new Plugin_Exception('� obrigatorio o uso do seletor');
		}
	...
	public function render(Zend_View_Interface $view = null)
	{
		...
		if ( empty($this->_cols) )
		{
			throw new Plugin_JQuery_Flexigrid_Exception('Nenhuma coluna adicionada ao flexigrid');
		}
		else
		{
		...
		//renderiza o flexigrid
		$view = $this->getView();
		$view->addHelperPath('Tavs/View/Helper/', 'Plugin_View_Helper_');
	...
	public function generateRows($data, $pk = null)
	{
		...
		{
			throw new Plugin_JQuery_Flexigrid_Exception('Tipo de informacao nao suportado');
		}
		return false;
	}
